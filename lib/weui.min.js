    ...
    return function (e) {
        ...
        function a() {
            ...
            return i && (n = t), n = u.default.extend({
                content: e,
                buttons: [{label: "确定", type: "primary", onClick: i ? u.default.noop : t}]
            }, n), (0, d.default)(n)
        }
        ...
        function a() {
            ...
            return a && (i = t), i = u.default.extend({
                content: e,
                buttons: [{label: "取消", type: "default", onClick: a ? u.default.noop : n}, {
                    label: "确定",
                    type: "primary",
            ...
            for (var t = l.default.extend({
                ...
                for (var u = 0; u < 12; u++) {
                    for (var d = [], f = 1; f < i[u] + 1; f++) {
                        var s = {label: f + "日", value: f};
                        d.push(s)
                    }
                    r.push({label: u + 1 + "月", value: u + 1, children: d})
                }
                var c = {label: a + "年", value: a, children: r};
                n.push(c)
            }
            return o(n, t)
        }
